...
def sync_detailed(
    *,
    ...
    """Get user ids by selector

     ## Description
    Get user ids by searching one or more selectors. This is an AND type query, meaning that it will
    return a user id only if it matches ALL of the criteria.
